...
public class SkipListDriver {
    public static void main(String[] args) throws FileNotFoundException {
    	/*
    	File file = new File("C:\\Users\\PC\\Downloads\\p2-in02.txt");
    	...
    	{
    		filecon = filecon.concat(sc.nextLine()+"\n");
    		System.out.println(sc.nextLine());
    	}
    	*/
    	Scanner sc;
    	...
    	{
    		File file = new File("C:\\Users\\PC\\Downloads\\p2-in01.txt");
    	    sc = new Scanner(file); // System.in
